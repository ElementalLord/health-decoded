...
export const toolSearchDocuments = [
  ...
  },
  {
    ...
    description: "Practice reading serving sizes, carbohydrates, fiber, sugars, and protein.",
    route: "/decode-the-label",
    aliases: ["nutrition label", "food label", "read a label", "label practice"],
    keywords: ["serving size", "total carbohydrate", "fiber", "added sugar", "protein"],
    priority: 1,
    status: "available",
  },
  {
    ...
    description: "Put a diabetes concept into your own words and check the main idea.",
    route: "/explain-it-back",
    aliases: ["teach it back", "explain a concept", "concept practice"],
    keywords: ["practice", "understanding", "blood glucose", "insulin", "A1C"],
    priority: 1,
    status: "available",
  },
  {
...
export const resourceSearchDocuments: readonly UniversalSearchDocument[] =
  type2DiabetesResources.map((resource) => ({
    ...
    route: `/resources#resource-${resource.id}`,
