...
const stages = [
  {
    id: "opening",
    group: "Orient",
    label: "Know the layers",
    headingId: "caregiver-module-4-heading",
  },
  {
    id: "scenario",
    group: "Notice",
    label: "The unfinished errand",
    headingId: "CG-M4-S03-heading",
  },
  ...
  { id: "plan", group: "Plan", label: "Use their plan", headingId: "CG-M4-S05-heading" },
  {
    id: "sources",
    group: "Choose",
    label: "Find the right source",
    headingId: "CG-M4-I02-heading",
  },
  { id: "handoff", group: "Hand off", label: "Start the call", headingId: "CG-M4-S06-heading" },
  {
    id: "improvise",
    group: "Pause",
    label: "Do not invent treatment",
    headingId: "CG-M4-S07-heading",
  },
  { id: "delay", group: "Notice", label: "One more reading", headingId: "CG-M4-S08-heading" },
  {
    id: "scripts",
    group: "Prepare",
    label: "Language to keep",
    headingId: "module-4-scripts-heading",
  },
  {
    id: "check",
    group: "Review",
    label: "Check your understanding",
    headingId: "m4-knowledge-heading",
  },
    ...
    >
      <header className={styles.lessonHeader}>
        ...
        <div className={styles.progressCopy}>
          ...
          <ProgressBar
            ...
            label={`Module 4 progress: part ${stageIndex + 1} of ${stages.length}`}
      ...
      <div className={styles.stageViewport}>
        <div className={styles.stage} data-stage="opening" hidden={stageIndex !== 0}>
          <Module4Orientation onBegin={() => goToStage(1)} />
        </div>
        ...
        <div className={styles.stage} data-stage="plan" hidden={stageIndex !== 3}>
          <Module4Plan />
        </div>
        <div className={styles.stage} data-stage="sources" hidden={stageIndex !== 4}>
          <GuidanceSourceMatching />
        </div>
        <div className={styles.stage} data-stage="handoff" hidden={stageIndex !== 5}>
          <Module4HandoffNarrative />
          <ProfessionalHandoffSequence />
        </div>
        <div className={styles.stage} data-stage="improvise" hidden={stageIndex !== 6}>
          <Module4UnsafeNarrative />
          <UnsafeImprovisationReview />
        </div>
        <div className={styles.stage} data-stage="delay" hidden={stageIndex !== 7}>
          <Module4Misunderstanding />
        </div>
        <div className={styles.stage} data-stage="scripts" hidden={stageIndex !== 8}>
          <Module4Scripts />
        </div>
        ...
        <div className={styles.stage} data-stage="takeaway" hidden={stageIndex !== 10}>
          <Module4Takeaway />
          <Module4Reflection />
          <Module4Completion onReview={() => goToStage(4)} />
        </div>
      </div>
