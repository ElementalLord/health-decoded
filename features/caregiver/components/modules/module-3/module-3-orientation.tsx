    ...
    <section className={styles.orientation} aria-labelledby="caregiver-module-3-heading">
      <div className={styles.orientationCopy}>
        ...
        <Button className={styles.beginButton} fullWidth={false} onClick={onBegin} type="button">
          Begin with dinner at seven <span aria-hidden="true">→</span>
        </Button>
      </div>
      <figure className={styles.orientationArt}>
        <Image
          src="/caregiver/module-3/shared-evening-plan.png"
          alt="Two roommates planning a shared evening at their kitchen table with groceries, dinner, and car keys."
          width={1536}
          height={1024}
          priority
