...
const contentBlockSchema = z.discriminatedUnion("type", [
  z.object({ body: plainText(2_000), heading: plainText(160).optional(), type: z.literal("text") }).strict(),
  z.object({ body: plainText(2_000), title: plainText(160), type: z.literal("callout") }).strict(),
  z.object({ points: z.array(plainText(320)).min(1).max(8), title: plainText(160), type: z.literal("list") }).strict(),
]);
