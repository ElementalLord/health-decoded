...
export default function MilestonesError({ reset }: { error: Error; reset: () => void }) {
  return (
    <section className="mx-auto max-w-2xl space-y-5 py-12">
      ...
      <h1 className="font-serif-display text-4xl font-medium">Milestones could not open</h1>
      <p className="leading-7 text-muted-foreground">Try again or return to your Journey.</p>
