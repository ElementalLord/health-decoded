...
function AppShell({ children, preferences, routes }: { children: ReactNode; preferences?: ProfileSettings; routes?: readonly ApplicationRoute[] }) {
  return (
    <div className="flex min-h-dvh flex-col" data-reduced-motion={preferences?.reducedMotion} data-text-scale={preferences?.preferredTextScale}>
      <a
