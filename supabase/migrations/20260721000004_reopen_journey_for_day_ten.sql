-- Learners who finished Day 9 can begin the newly published Day 10. Earlier
-- learners remain where they are, and completed Day 10 progress is preserved.
...
set
  current_journey_lesson_id = day_ten.id,
  completed_at = null,
