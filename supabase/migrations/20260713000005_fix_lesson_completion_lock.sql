...
declare
  ...
  v_existing_xp pg_catalog.int4;
  v_existing_completed_at pg_catalog.timestamptz;
  v_last_viewed_block pg_catalog.int4;
  v_block_count pg_catalog.int4;
  v_display_order pg_catalog.int4;
  ...
  v_journey_completed pg_catalog.bool := false;
begin
  ...
  for update of lesson_progress, user_journeys;
